...
* 
*                        Token: Tips (Tips)
*                      Website: https://tipscoin.io
*                     Telegram: https://t.me/TipsCoinOfficial
*                   Whitepaper: https://tipscoin.io/whitepaper.pdf
*                       E-mail: support@tipscoin.io
*
*                         Bots:/u/TipsCoinBot (Reddit)
*                                @TipsCoinBot (Twitter)
*                                @TipsCoinBot (Telegram)
*
*                      Website: https://bot.tipscoin.io                        
*                     Telegram: https://t.me/TipsCoinBotOfficial
*
* IMPORTANT
...
* We don't offer financial instruments, stocks or shares in any company. 
* We are not a licensed financial advisors or registered investment advisors. 
* Always do your own research and due diligence before investing in BSC tokens.
* Trading cryptocurrencies poses considerable risk of loss. Don’t invest any money you can’t afford to lose.
* You should always consult with a licensed financial advisor before investing in any cryptocurrency related product.
* You must be 18+ to interact with this smart contract.
* 
*/
...
contract Tips is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = 0x567695a2bb6153b551E2f51f905Dcf120bDeD749;
    ...
    // Max Tx Amount = 5,000,000,000,000 Tips
    uint256 public _maxTxAmount = 5000000 * 10**6 * 10**9;

    // SwapAndLiquify = 500,000,000,000 Tips
    ...
    function _transfer(
        ...
        //Don't use bots. Blacklisted wallets can not buy or sell.
